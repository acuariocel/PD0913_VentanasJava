...
public class Ventana8 extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (!jtxtNombres.getText().isEmpty()
                && !jtxtApellidos.getText().isEmpty()
                && !jtxtEdad.getText().isEmpty()
                && !jtxtCelular.getText().isEmpty()) {
            JOptionPane.showMessageDialog(null,"Datos guardados correctamente");
            jtxtNombres.setText(null);
            jtxtApellidos.setText(null);
            jtxtEdad.setText(null);
            jtxtCelular.setText(null);

        }else {
            JOptionPane.showMessageDialog(null,"Datos no guardados","Error Al Guardar",JOptionPane.ERROR_MESSAGE);
        }
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jtxtNombresKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jtxtNombresKeyReleased
        System.out.println("Solto tecla");
